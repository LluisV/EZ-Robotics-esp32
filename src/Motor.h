/**
 * @file Motor.h
 * @brief Motor control adapted to use FluidNC-style stepper system
 */
 ...
 public:
      ...
      */
     bool moveTo(long position, float speed = 0.0f);
 ...
 private:
     ...
     int axis;                           ///< Axis index for this motor
     int motorNum;                       ///< Motor number on the axis
 };
