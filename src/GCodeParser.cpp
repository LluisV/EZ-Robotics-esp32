 ...
 * @brief Implementation of the GCodeParser class with modification to remember last target position
 */
       ...
       lastFeedrate(1000.0f)
 {
   ...
   // Initialize lastTargetPosition with current position if available
